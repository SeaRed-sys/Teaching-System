...
{
    /// <summary>
    /// AfDockLayout : 利用Dock属性进行布局
    /// </summary>
    public class AfDockLayout : Panel
    {
        // 左、上、右、下
        ...
        [Browsable(true)]
        [Editor(typeof(AfDockFlagEditorType), typeof(UITypeEditor))]
    ...
    /// </summary>
    class AfDockFlagEditorType : UITypeEditor
    {
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            if (context != null && context.Instance != null && provider != null)
            {
                ...
                {
                    // 自定义控件
                    AfDockLayout owner = (AfDockLayout)context.Instance;
                    AfDockFlagEditor editorUi = new AfDockFlagEditor();
    ...
    /// </summary>
    [ToolboxItem(false)]
    class AfDockFlagEditor : UserControl
    {
